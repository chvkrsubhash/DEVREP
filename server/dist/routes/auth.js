 ...
 */
exports.authRouter.get('/github', (req, res) => {
    if (!GITHUB_CLIENT_ID) {
 ...
 */
exports.authRouter.get('/github/callback', async (req, res) => {
    ...
    try {
        ...
        const encryptedToken = (0, crypto_1.encryptToken)(accessToken);
        const dbUser = await (0, users_1.upsertUser)(String(ghUser.id), ghUser.login, ghUser.avatar_url, encryptedToken);
